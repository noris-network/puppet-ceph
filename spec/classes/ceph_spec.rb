...
describe 'ceph' do
  ...
  it { should contain_concat__fragment('ceph-main').with_content(/^cluster network\s+= 1.2.3.4\/24$/) }
  it { should contain_concat__fragment('ceph-main').with_content(/^public network\s+= 5.6.7.8\/24$/) }
  it { should contain_concat__fragment('ceph-main').with_content(/^osd pool default crush replicated ruleset\s+= 0$/) }
  it { should contain_concat__fragment('ceph-main').with_content(/^osd pool default size\s+= 3$/) }
